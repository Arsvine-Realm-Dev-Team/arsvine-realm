...
date: "2026-05-20"
excerpt: "For a friend whose nickname is 'Tsuki' (Moon)"
tags: ["Tsuki", "Friend"]
pinned: false
originLocale: zh-CN
---

She is thinking: if only every night could be a full moon. But it is not as if she does not know—
the moon has its own orbit. From a thin crescent, to a swelling gibbous moon, to the fullness of the fifteenth night, every step is a change. She simply cannot help asking, quietly, somewhere inside herself: is there any way to skip the nights that are not bright enough?
