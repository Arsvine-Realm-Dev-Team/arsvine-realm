                  ...
                  if (!safeUrl) {
                    ...
                    parts.push(
                      <span key={lastIndex} className={styles.iconLinkContainer}>
                        <a href={safeUrl.href} target="_blank" rel="noopener noreferrer" className={styles.inlineIconLink} aria-label={linkText}>
                    ...
                    parts.push(
                      <a key={lastIndex} href={safeUrl.href} target="_blank" rel="noopener noreferrer" className={styles.inlineLink}>
                        {linkText}
                      </a>
                    );
                  }
